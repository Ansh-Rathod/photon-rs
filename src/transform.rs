...
pub fn seam_carve(img: &PhotonImage, width: u32, height: u32) -> PhotonImage {
    let mut img: RgbaImage =
        ImageBuffer::from_raw(img.get_width(), img.get_height(), img.raw_pixels.to_vec()).unwrap();
...
/// ```
#[cfg_attr(feature = "enable_wasm", wasm_bindgen)]
pub fn padding_uniform(img: &PhotonImage, padding: u32, padding_rgba: Rgba) -> PhotonImage {
...
/// ```
#[cfg_attr(feature = "enable_wasm", wasm_bindgen)]
pub fn padding_right(img: &PhotonImage, padding: u32, padding_rgba: Rgba) -> PhotonImage {
    let image_buffer = img.get_raw_pixels();
    let img_width = img.get_width();
    let img_height = img.get_height();
...
/// ```
#[cfg_attr(feature = "enable_wasm", wasm_bindgen)]
pub fn padding_bottom(img: &PhotonImage, padding: u32, padding_rgba: Rgba) -> PhotonImage {
    let image_buffer = img.get_raw_pixels();
    let img_width = img.get_width();
    let img_height = img.get_height();
